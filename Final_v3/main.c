...
GtkWidget *u_name, *pass, *resultat_assemblage, *resultat_recherche, *chercher, *win;
...
{
    GtkWidget *label, *grid2, *assembler, *chercher_button, *Quit_button2;
    ...
    if (compare==0)
    {
        if (password==PASSWORD)
        {
            ...
            resultat_assemblage = gtk_label_new("Voir console");
